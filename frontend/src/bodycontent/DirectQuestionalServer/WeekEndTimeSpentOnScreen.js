...
export default function WeekEndTimeSpentOnScreen() {
  ...
  useEffect(() => {
    const getuserFunction = async () => {
      ...
      result.forEach((user) => {
        updateValue = {
          ...updateValue,
          [user.weekendtimespanviewingelectronics.tvwatchingtime]:
        ...
        updateValue1 = {
          ...
          updateValue2 = {
            ...updateValue2,
            [user.weekendtimespanviewingelectronics.laptopwatchingtime]:
              updateValue2[user.weekdaytimespanviewingelectronics.laptopwatchingtime] + 1,
          };
          updateValue3 = {
            ...updateValue3,
            [user.weekendtimespanviewingelectronics.tabletwatchingtime]:
    ...
    <div>
      <Box>
        <Heading fontSize={"1.4rem"} mb={"4%"}>
          Weekend screen watching time distribution
        </Heading>
