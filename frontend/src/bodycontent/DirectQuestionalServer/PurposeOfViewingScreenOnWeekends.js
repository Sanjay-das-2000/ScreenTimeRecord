...
export default function PurposeOfViewingScreenOnWeekends() {
  ...
  useEffect(() => {
    const getuserFunction = async () => {
      ...
      result.forEach((user) => {
        updateValue = {
          ...updateValue,
          [user.purposeofviewscreenonweekends.foreducation]:
            updateValue[user.purposeofviewscreenonweekends.foreducation] + 1,
        };
        updateValue1 = {
            ...updateValue1,
            [user.purposeofviewscreenonweekends.forentertainment]:
              updateValue1[user.purposeofviewscreenonweekends.forentertainment] + 1,
          };
          updateValue2 = {
            ...updateValue2,
            [user.purposeofviewscreenonweekends.forplayinggames]:
              updateValue2[user.purposeofviewscreenonweekends.forplayinggames] + 1,
          };
          updateValue3 = {
            ...updateValue3,
            [user.purposeofviewscreenonweekends.invideocalls]:
              updateValue3[user.purposeofviewscreenonweekends.invideocalls] + 1,
          };
          updateValue4 = {
            ...updateValue4,
            [user.purposeofviewscreenonweekends.duringeating]:
              updateValue4[user.purposeofviewscreenonweekends.duringeating] + 1,
          };
          updateValue5 = {
            ...updateValue5,
            [user.purposeofviewscreenonweekends.beforebed]:
              updateValue5[user.purposeofviewscreenonweekends.beforebed] + 1,
          };
          updateValue6 = {
            ...updateValue6,
            [user.purposeofviewscreenonweekends.toengage]:
              updateValue6[user.purposeofviewscreenonweekends.toengage] + 1,
          };
      });
    ...
    <div>
      <Box>
        <Heading fontSize={"1.4rem"} mb={"4%"}>
          Purpose of viewing screen on weekends distribution
        </Heading>
